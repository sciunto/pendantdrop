...
from pendant_drop_functions import find_circle,theoretical_contour,rotate_lines,partial_ksi,error_calculation,error_calculation_2
#import pendant_drop_functions
...
#zoom=[[600,1590],[1000,1850]]

#zoom=[[1000,1695],[1050,1750]]
#zoom=[[875,1695],[1050,1750]]
#zoom=[[750,1695],[850,1950]]
image1=image[zoom[0][0]:zoom[0][1],zoom[1][0]:zoom[1][1]]

#tetabis=-0.01075836181169
#image1=rotate(image1,tetabis)

edges = feature.canny(color.rgb2gray(image1), sigma=2.5)
image=edges

#hough_radii = np.arange(300,330)
#hough_radii = np.arange(365,380)
hough_radii = np.arange(418,440)
#hough_radii=np.arange(330,360)#bubble growth 12/03/2018 2
#hough_radii=[429]
